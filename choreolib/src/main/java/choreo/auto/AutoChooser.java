...
public class AutoChooser {
   ...
   *
   * <p>The AutoRoutine can only be updated when the robot is disabled and connected to driverstation.
   * If the chooser in your dashboard says {@code BAD} the {@link AutoChooser} has not responded
   * to the selection yet and you need to disable the robot to update it.
   */
  public void update() {
