...
void choreo::to_json(wpi::util::json& json,
    ...
    json = wpi::util::json::object("t", trajectorySample.timestamp.value(), "x",
                                                                 ...
                                                                 trajectorySample.heading.value(), "vl",
                                                                 trajectorySample.vl.value(), "vr",
                                                                 trajectorySample.vr.value(), "omega",
                                                                 trajectorySample.omega.value(), "al",
                                                                 trajectorySample.al.value(), "ar",
                                                                 trajectorySample.ar.value(), "fl",
                                                                 trajectorySample.fl.value(), "fr",
                                                                 trajectorySample.fr.value());
}
...
void choreo::from_json(const wpi::util::json& json,
  ...
  trajectorySample.vl = wpi::units::meters_per_second_t{json.at("vl").get_number()};
  trajectorySample.vr = wpi::units::meters_per_second_t{json.at("vr").get_number()};
