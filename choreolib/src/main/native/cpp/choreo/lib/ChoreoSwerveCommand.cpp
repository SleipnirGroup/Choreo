...
ChoreoSwerveCommand::ChoreoSwerveCommand(ChoreoTrajectory trajectory,
		...
		bool useAllianceColor, frc2::Requirements requirements) : m_traj(
		trajectory), m_pose(poseSupplier), m_controller(controller), m_outputChassisSpeeds(
		outputChassisSpeeds), m_useAlliance(useAllianceColor) {
