...
public class TrajectoryTestHelper {
    ...
    public static <SampleType extends TrajectorySample<SampleType>> Trajectory<SampleType> linearTrajectory(String name, Pose2d start, Pose2d end, double duration, Class<SampleType> sampleType) {
