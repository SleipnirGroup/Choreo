...
#ifdef TRAJOPT_EXPORTS
#ifdef __GNUC__
#define TRAJOPT_DLLEXPORT __attribute__((dllexport))
#else
#define TRAJOPT_DLLEXPORT __declspec(dllexport)
#endif

#elif defined(TRAJOPT_IMPORTS)

#ifdef __GNUC__
#define TRAJOPT_DLLEXPORT __attribute__((dllimport))
#else
#define TRAJOPT_DLLEXPORT __declspec(dllimport)
#endif

#else
#define TRAJOPT_DLLEXPORT
#endif

#else  // _WIN32

#ifdef TRAJOPT_EXPORTS
#define TRAJOPT_DLLEXPORT __attribute__((visibility("default")))
#else
#define TRAJOPT_DLLEXPORT
#endif
