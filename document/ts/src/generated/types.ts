...
/**
 * A document-level scalar variable payload. The dimension tag selects the SI unit.
 *
 * This interface was referenced by `ChoreoDocumentSchema`'s JSON-Schema
...
/**
 * Named scalar/dimensional variable keyed by UUID in variables.expressions.
 *
 * This interface was referenced by `ChoreoDocumentSchema`'s JSON-Schema
 * via the `definition` "ExpressionVariableEntry".
 */
...
/**
 * Named translation variable keyed by UUID in variables.translations.
 *
 * This interface was referenced by `ChoreoDocumentSchema`'s JSON-Schema
 * via the `definition` "TranslationVariableEntry".
 */
export interface TranslationVariableEntry {
  name: string;
  value: Translation2E;
}
/**
 * Named pose variable keyed by UUID in variables.poses.
 *
 * This interface was referenced by `ChoreoDocumentSchema`'s JSON-Schema
 * via the `definition` "PoseVariableEntry".
 */
export interface PoseVariableEntry {
  name: string;
  value: Pose2E;
}
/**
 * Named region variable keyed by UUID in variables.regions.
 *
 * This interface was referenced by `ChoreoDocumentSchema`'s JSON-Schema
 * via the `definition` "RegionVariableEntry".
 */
export interface RegionVariableEntry {
  name: string;
  value: Region2E;
}
/**
 * All document-level variables keyed by UUID, grouped by variable kind.
 *
 * This interface was referenced by `ChoreoDocumentSchema`'s JSON-Schema
...
export interface Variables {
  /**
   * Scalar/dimensional variables keyed by UUID.
   */
  expressions?: {
    [k: string]: ExpressionVariableEntry;
  };
  /**
   * 2D translation variables keyed by UUID.
   */
  translations?: {
    [k: string]: TranslationVariableEntry;
  };
  /**
   * 2D pose variables keyed by UUID.
   */
  poses?: {
    [k: string]: PoseVariableEntry;
  };
  /**
   * 2D region variables keyed by UUID.
   */
  regions?: {
    [k: string]: RegionVariableEntry;
  };
}
/**
