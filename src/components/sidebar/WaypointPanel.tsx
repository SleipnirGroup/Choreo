        ...
        <div className={styles.WaypointPanel} style={{ width: (this.context.uiState.waypointPanelOpen ? "" : "auto") }}>
          <span style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start' }}>
            <Tooltip title='Delete Waypoint'>
              <IconButton onClick={() => this.context.model.pathlist.activePath.deleteWaypointUUID(waypoint?.uuid || "")}>
                <DeleteIcon />
              </IconButton>
            </Tooltip>
            <Tooltip title="Edit Waypoint">
              <IconButton onClick={() => this.context.uiState.setWaypointPanelOpen(!this.context.uiState.waypointPanelOpen)}>
                <EditIcon />
              </IconButton>
            </Tooltip>
          </span>
