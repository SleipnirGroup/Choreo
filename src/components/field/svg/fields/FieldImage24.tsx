  ...
  render() {
    return (
      <g id="layer1" transform={`scale(1, -1)`}>
        <g
          id="img"
          transform={`translate(0, ${-WIDTH_M}) scale(${0.0175}) translate(-6, -10)`}
          opacity={"100%"}
        >
          <rect
            x="476.5"
          ...
          <path
            d="M7 127H31C32.1046 127 33 127.895 33 129V194C33 195.105 32.1046 196 31 196H7V127Z"
            fill="#585858"
            id="path19"
          />
          <path
            d="M141 6.5L141 8.5C141 9.60457 140.105 10.5 139 10.5L82 10.5C80.8954 10.5 80 9.60457 80 8.5L80 6.5L141 6.5Z"
            fill="#585858"
            id="path20"
          />
          <path
            d="M10.9999 420.402L11.952 418.756C12.505 417.8 13.7292 417.472 14.6862 418.023L40.6788 433.003C41.6358 433.554 41.9633 434.777 41.4102 435.733L40.4581 437.379L10.9999 420.402Z"
            fill="#585858"
            id="path21"
          />
          <path
            d="M42.1794 438.404L43.1315 436.758C43.6846 435.801 44.9087 435.473 45.8658 436.025L71.8583 451.004C72.8154 451.556 73.1428 452.778 72.5898 453.734L71.6377 455.38L42.1794 438.404Z"
            fill="#585858"
            id="path22"
          />
          <path
            d="M73.359 456.405L74.3111 454.759C74.8641 453.803 76.0883 453.475 77.0453 454.026L103.038 469.006C103.995 469.558 104.322 470.78 103.769 471.736L102.817 473.382L73.359 456.405Z"
            fill="#585858"
            id="path23"
          />
          <path
          ...
          <rect
            width="32"
            height="32"
            transform="matrix(0.499997 0.866027 0.866023 -0.500004 608.647 164.531)"
            fill="#262626"
            id="rect27"
          />
          <rect
          ...
          <rect
            width="32"
            height="32"
            transform="matrix(0.499996 -0.866027 -0.866023 -0.500003 636.359 339.469)"
            fill="#262626"
            id="rect29"
          />
          <path
          ...
          />
          <path
            d="M816.001 6.5L816.001 8.5C816.001 9.60457 816.897 10.5 818.001 10.5L875.001 10.5C876.105 10.5 877.001 9.60457 877.001 8.5L877.001 6.5L816.001 6.5Z"
            fill="#585858"
            id="path38"
          />
          <path
          ...
          />
          <path
            d="M5 6V244V417.5L115 480H842L952 417.5V6H5Z"
            stroke="#FFFFFF"
            fill="none"
            strokeWidth="2"
            strokeLinejoin="round"
