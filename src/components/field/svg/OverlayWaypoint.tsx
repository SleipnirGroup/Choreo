...
class OverlayWaypoint extends Component<Props, State> {
  ...
  componentDidMount() {
    if (this.rootRef.current) {
      d3.select<SVGCircleElement, undefined>(`#waypointGroup${this.props.index}`).on("contextmenu", (e) => {
        ...
        this.context.model.uiState.setContextMenuSelectedWaypoint(this.props.index);
        this.context.model.uiState.setContextMenuWaypointType(this.context.model.document.pathlist.activePath.waypoints[this.props.index].type);
      });
