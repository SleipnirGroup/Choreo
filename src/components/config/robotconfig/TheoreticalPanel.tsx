...
class RobotConfigPanel extends Component<Props, State> {
  ...
  render() {
    ...
    const minimumLinearForce = Math.min(motorFloorLinearForce, frictionFloorLinearForce);
    ...
    return (
      ...
      <InputList noCheckbox rowGap={this.props.rowGap}>
        <Input
          ...
          setEnabled={(_) => null}
          roundingPrecision={3}
          number={imp ? MToFt(frictionFloorLinearAccel) : frictionFloorLinearAccel}
          setNumber={() => null}
          showCheckbox={false}
        ...
        <Input
          ...
          setEnabled={(_) => null}
          roundingPrecision={3}
          number={imp ? MToFt(motorFloorLinearAccel) : motorFloorLinearAccel}
          setNumber={() => null}
          showCheckbox={false}
