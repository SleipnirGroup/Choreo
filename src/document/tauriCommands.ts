...
export const Commands = {
    ...
    openChor:       (dir:string, name:string)=>              invoke<Project>("open_chor", {path:[dir, name]}),
    openTraj:       (dir:string, name:string)=>              invoke<Traj>("open_traj", {path:[dir, name]}),
    ...
    setChorPath:    (dir: string, name:string)=>              invoke<void>("set_chor_path", {dir, name})
