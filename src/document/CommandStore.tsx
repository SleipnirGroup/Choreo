import {
  ...
  import { PplibCommand, Expr, Command, ChoreolibEvent, NamedCommand, GroupCommand, WaitCommand } from "./2025/DocumentTypes";
  ...
  export function commandIsNamed(
    command: Command
  ): command is NamedCommand {
    return command.type === "named";
  }
  export function commandTypeIsGroup(
    type: CommandType
  ) {
