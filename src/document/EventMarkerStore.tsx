import { IAnyType, Instance, types, getRoot, isAlive, getParent } from "mobx-state-tree";
...
export const EventMarkerStore = types.model("EventMarker", {
    name: types.string,
