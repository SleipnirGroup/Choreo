...
export const EXPR_DEFAULTS : RobotConfig<Expr> = {
  ...
  inertia: ["6 kg*m^2", 6],
  vmax: [`${MotorCurves.KrakenX60.vmax * 0.8} rpm`, MotorCurves.KrakenX60.vmax * 0.8],
  tmax: [`${maxTorqueCurrentLimited(MotorCurves.KrakenX60.kt, 60)} N*m`, maxTorqueCurrentLimited(MotorCurves.KrakenX60.kt, 60)],
...
export const BumperStore = types.model("BumperStore", {
...
export const RobotConfigStore = types
  .model("RobotConfigStore", {
    ...
    bumper: BumperStore,
    modules: types.refinement("Modules", types.array(ModuleStore), (snap)=>snap?.length==4),
