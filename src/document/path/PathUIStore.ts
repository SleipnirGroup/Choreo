...
import { DifferentialDriveSample, type SwerveSample } from "../2025/DocumentTypes";
...
export const PathUIStore = types
  .model("PathUIStore", {
    ...
    generationProgress: types.frozen<Array<SwerveSample> | Array<DifferentialDriveSample>>([]),
    generating: false,
  ...
  .actions((self) => ({
    ...
    setInProgressTrajectory(trajectory: Array<SwerveSample> | Array<DifferentialDriveSample>) {
      getEnv<Env>(self).withoutUndo(() => {
